...
export default function GamificacaoPage() {
  ...
  const pointActions = [
    ...
    },
    {
      ...
      points: 50,
      icon: <FaMedal className="text-lucy" />,
    },
    {
  ...
  if (loading)
    return (
      <div className="flex justify-center items-center h-60 text-lucy font-semibold">
    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-purple-100 to-purple-100 p-4 sm:p-6">
      <div className="max-w-6xl mx-auto space-y-10">
        ...
        >
          ...
          <div>
            <h1 className="text-3xl font-bold text-lucy">
              Pontuação Total
            </h1>
            <motion.p
              animate={{ scale: [1, 1.05, 1] }}
              transition={{ repeat: Infinity, duration: 2 }}
              className="text-4xl font-extrabold text-lucy"
            >
              {animatedPoints}
            </motion.p>
        ...
        <div className="bg-white p-5 rounded-2xl shadow border border-purple-100">
          ...
          <div className="w-full bg-gray-200 rounded-full h-4 overflow-hidden">
            <motion.div
              ...
              className="h-4 bg-gradient-to-r from-purple-500 to-lucy"
        ...
        <div className="bg-white rounded-2xl shadow p-6 border border-purple-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <FaMedal className="text-lucy" /> Conquistas
          </h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 border border-purple-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <FaRocket className="text-lucy" /> Como conseguir pontos
          </h2>
        ...
        <div className="bg-white rounded-2xl shadow p-6 border border-purple-100">
          <h2 className="text-lg font-semibold text-gray-800 mb-3 flex items-center gap-2">
            <FaChartLine className="text-lucy" /> Últimas ações
          </h2>
          {summary?.recent?.length ? (
            <ul className="space-y-2 text-sm text-gray-700">
              {summary.recent.map((r) => (
                ...
                >
                  <span className="font-semibold text-lucy">
